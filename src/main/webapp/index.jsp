...
<div id="myCarousel" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner" role="listbox">
      <div class="item active">
        <img src="resources/images/sameimage2.jpg" text="IMAGE" alt="Image">
      ...
      <div class="item">
        <img src="resources/images/sameimage3.jpg" text=Another Image Maybe" alt="Image">
        <div class="carousel-caption">
          <h3>Sujai Krishna</h3>
          <p>Lorem ipsum...</p>
        </div>
      ...
      <div class="item">
        <img src="resources/images/roadimage.jpg">
      </div>
...
<div class="container text-center">
  ...
  <div class="row">
    <div class="col-sm-4">
      <img src="resources/images/image2.jpg" class="img-responsive" style="width:75%" alt="Image">
      <p>Current Project</p>
    </div>
    <div class="col-sm-4">
      <img src="resources/images/image3.jpg" class="img-responsive" style="width:100%" alt="Image">
      <p>Project 2</p>
    </div>
    <div class="col-sm-4">
      <img src="resources/images/image3.jpg" class="img-responsive" style="width:100%" alt="Image">
